...
def web_info() -> rx.Component:
    return rx.box(
        rx.vstack(
            ...
            rx.text(
                "Tu opinión es fundamental para nosotros. Si tienes sugerencias, comentarios o alguna experiencia que deseas compartir, ¡estamos aquí para escucharte! Tu retroalimentación nos ayuda a evolucionar y a adaptarnos a tus necesidades. No dudes en compartir tus pensamientos en nuestro feed."
            )
        ),
