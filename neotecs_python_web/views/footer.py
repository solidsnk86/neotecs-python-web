    ...
    return rx.box(
        rx.vstack(
            ...
            rx.hstack(
                rx.flex(
                    rx.text(
                    f"© {YEAR} NeoTecs · Desarrollo por", rx.link(
        ...
        class_name=f"text-zinc-600 text-[10px] transition-all w-full pt-[{Size.EXTRA_BIG.value}] border-t-2 boder-zinc-400 xl:flex flex-col px-4 xl:text-initial text-center"
    )